...
<?php /*%%SmartyHeaderCode:14833570cd37107b273-03063718%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14833570cd37107b273-03063718',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_570cd371098fb5_43150665',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_570cd371098fb5_43150665')) {function content_570cd371098fb5_43150665($_smarty_tpl) {?><?php if (!is_callable('smarty_function_mailto')) include 'C:\\Development\\programs\\xampp\\htdocs\\heizfabrik\\core\\vendor\\smarty\\smarty\\libs\\plugins\\function.mailto.php';
...
<?php $_tmp16=ob_get_clean();?><?php if ($_tmp16) {?>
                        <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['config'][0][0]->configDataAccess(array('key'=>"store_country"),$_smarty_tpl);?>
<?php $_tmp17=ob_get_clean();?><?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('type'=>"country",'name'=>"address.country.title",'id'=>$_tmp17)); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"country",'name'=>"address.country.title",'id'=>$_tmp17), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
</span><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('type'=>"country",'name'=>"address.country.title",'id'=>$_tmp17), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php $_tmp19=ob_get_clean();?><?php if ($_tmp19) {?>
        <li class="contact-email">
            <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['config'][0][0]->configDataAccess(array('key'=>"store_email"),$_smarty_tpl);?>
<?php $_tmp20=ob_get_clean();?><?php echo smarty_function_mailto(array('address'=>$_tmp20,'encode'=>"hex",'extra'=>'class="email" itemprop="email"'),$_smarty_tpl);?>

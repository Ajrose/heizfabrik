<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-04-14 20:06:44
         compiled from "C:\Development\programs\xampp\htdocs\heizfabrik\templates\frontOffice\default\includes\product-suggestion.html" */ ?>
<?php /*%%SmartyHeaderCode:13309570fd5a0afc8b9-84699527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d804bef07cb685b29058055b6875f09f1f8f4bf' => 
    array (
      0 => 'C:\\Development\\programs\\xampp\\htdocs\\heizfabrik\\templates\\frontOffice\\default\\includes\\product-suggestion.html',
      1 => 1460657201,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13309570fd5a0afc8b9-84699527',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_570fd5a0bdea26_64532935',
  'variables' => 
  array (
    'colClass' => 0,
    'PSE_COUNT' => 0,
...
<?php if ($_valid && !is_callable('content_570fd5a0bdea26_64532935')) {function content_570fd5a0bdea26_64532935($_smarty_tpl) {?><li class="item <?php echo TheliaSmarty\Template\SmartyParser::theliaEscape((($tmp = @$_smarty_tpl->tpl_vars['colClass']->value)===null||$tmp==='' ? "col-md" : $tmp),$_smarty_tpl);?>
">
...
" itemprop="url" tabindex="-1"
				class="product-image<?php if ($_smarty_tpl->tpl_vars['hasQuickView']->value==true) {?> product-quickview<?php }?> overlay col-sm-3">
...
"> <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['loop'][0][0]->theliaLoop(array('name'=>"product_thumbnail",'type'=>"image",'product'=>$_smarty_tpl->tpl_vars['product_id']->value,'width'=>((string)$_smarty_tpl->tpl_vars['width']->value),'height'=>((string)$_smarty_tpl->tpl_vars['height']->value),'resize_mode'=>"borders",'limit'=>"1"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
 ...
 <img itemprop="image"
				src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->functionImage(array('file'=>'assets/dist/img/218x146.png'),$_smarty_tpl);?>
"
				class="img-responsive" alt="<?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['productTitle']->value,$_smarty_tpl);?>
...
"><span itemprop="name"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['productTitle']->value,$_smarty_tpl);?>
				...
				<?php }?> <?php if ($_smarty_tpl->tpl_vars['hasGrade']->value) {?>
				<div class="short-description" itemprop="description">
					<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Grade",'d'=>"hookkonfigurator.fo.default"),$_smarty_tpl);?>
: <?php echo $_smarty_tpl->tpl_vars['GRADE']->value;?>
</p>
				</div>
				<?php }?> <?php if ($_smarty_tpl->tpl_vars['hasPower']->value) {?>
				<div class="short-description" itemprop="description">
					<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Power",'d'=>"hookkonfigurator.fo.default"),$_smarty_tpl);?>
: <?php echo $_smarty_tpl->tpl_vars['POWER']->value;?>
</p>
				</div>
				<?php }?> <?php if ($_smarty_tpl->tpl_vars['hasWarmwater']->value) {?>
				<div class="short-description" itemprop="description">
					<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Warmwater",'d'=>"hookkonfigurator.fo.default"),$_smarty_tpl);?>
:
						<?php echo $_smarty_tpl->tpl_vars['WARMWATER']->value;?>
</p>
				</div>
				<?php }?>
			</div>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1!=0) {?> <?php if ($_smarty_tpl->tpl_vars['VIRTUAL']->value==0&&$_smarty_tpl->tpl_vars['QUANTITY']->value<=0) {?> <?php $_smarty_tpl->tpl_vars["current_stock_content"] = new Smarty_variable("out_stock", null, 0);?> <?php $_smarty_tpl->tpl_vars["current_stock_href"] = new Smarty_variable("http://schema.org/OutOfStock", null, 0);?> <?php }?> <?php }?>

			<div class="product-price col-sm-3">
				<div class="price-container row" itemprop="offers" itemscope
...
">
					...
					<meta itemprop="itemCondition" itemscope
						itemtype="http://schema.org/NewCondition">
...
" />
					<?php if ($_smarty_tpl->tpl_vars['IS_PROMO']->value) {?> <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['count'][0][0]->theliaCount(array('type'=>"product_sale_elements",'promo'=>"1",'product'=>$_smarty_tpl->tpl_vars['ID']->value),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["combination_count"] = new Smarty_variable($_tmp2, null, 0);?> <span
						class="special-price col-xs-6"><span itemprop="price"
						class="price-label"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Special Price:"),$_smarty_tpl);?>
 </span><span
						class="price"> <?php if ($_smarty_tpl->tpl_vars['combination_count']->value>1) {?> <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['currency'][0][0]->currencyDataAccess(array('attr'=>"symbol"),$_smarty_tpl);?>
...
<?php $_tmp4=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"From
							%price",'price'=>$_tmp4),$_smarty_tpl);?>
 <?php } else { ?> <?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['currency'][0][0]->currencyDataAccess(array('attr'=>"symbol"),$_smarty_tpl);?>
<?php $_tmp5=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_money'][0][0]->formatMoney(array('number'=>$_smarty_tpl->tpl_vars['BEST_TAXED_PRICE']->value,'symbol'=>$_tmp5),$_smarty_tpl);?>
 <?php }?> </span></span>
					<?php if ($_smarty_tpl->tpl_vars['SHOW_ORIGINAL_PRICE']->value) {?> <span class="old-price col-xs-6"><span
						class="price-label"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Regular Price:"),$_smarty_tpl);?>
 </span><span
						class="price"><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['currency'][0][0]->currencyDataAccess(array('attr'=>"symbol"),$_smarty_tpl);?>
...
</span></span> <?php }?> <?php } else { ?> <span
						class="regular-price col-xs-12"><span itemprop="price"
						class="price"><?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['currency'][0][0]->currencyDataAccess(array('attr'=>"symbol"),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_money'][0][0]->formatMoney(array('number'=>$_smarty_tpl->tpl_vars['BEST_TAXED_PRICE']->value,'symbol'=>$_tmp7),$_smarty_tpl);?>
				...
				<?php if ($_smarty_tpl->tpl_vars['hasBtn']->value==true) {?> <?php if ($_smarty_tpl->tpl_vars['hasSubmit']->value==true&&$_smarty_tpl->tpl_vars['current_stock_content']->value=="in_stock") {?> <?php $_smarty_tpl->smarty->_tag_stack[] = array('form', array('name'=>"thelia.cart.add")); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['form'][0][0]->generateForm(array('name'=>"thelia.cart.add"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"
					/cart/add"),$_smarty_tpl);?>
" method="post" class="form-product">
 ...
 <input type="hidden" name="view"
						value="product"> <input type="hidden" name="product_id"
...
" value="1"> <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['form_field'][0][0]->renderFormField(array('field'=>"append"), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
 <?php if ($_smarty_tpl->tpl_vars['form_error']->value) {?>
					<div class="alert alert-error"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['form_error_message']->value,$_smarty_tpl);?>
</div>
					<?php }?> <?php $_smarty_tpl->smarty->_tag_stack[] = array('form_field', array('field'=>'product_sale_elements_id')); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['form_field'][0][0]->renderFormField(array('field'=>'product_sale_elements_id'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 <input
						type="hidden" class="pse-id" name="<?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['name']->value,$_smarty_tpl);?>
"
...
"<?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['attr']->value,$_smarty_tpl);?>
 >
					...
					<fieldset class="product-cart form-inline">
						...
						<div
							class="form-group group-qty hide <?php if ($_smarty_tpl->tpl_vars['error']->value) {?>has-error<?php } elseif ($_smarty_tpl->tpl_vars['value']->value!=''&&!$_smarty_tpl->tpl_vars['error']->value) {?>has-success<?php }?>">
...
"><?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['label']->value,$_smarty_tpl);?>
								...
								type="number" name="<?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['name']->value,$_smarty_tpl);?>
...
" min="0" required>
							<?php if ($_smarty_tpl->tpl_vars['error']->value) {?> <span class="help-block"><i
								class="fa fa-remove"></i> <?php echo TheliaSmarty\Template\SmartyParser::theliaEscape($_smarty_tpl->tpl_vars['message']->value,$_smarty_tpl);?>
</span> <?php } elseif ($_smarty_tpl->tpl_vars['value']->value!=''&&!$_smarty_tpl->tpl_vars['error']->value) {?> <span class="help-block"><i class="fa fa"></i></span>
							<?php }?>
						</div>
						...
						<div>
							<div class="product-btn">
								<button type="submit" class="btn btn-primary btn-block">
									<i class="fa fa-shopping-cart"></i> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Add to cart"),$_smarty_tpl);?>
...
" class="btn btn-primary btn-block"><i
							class="fa fa-eye"></i> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"View product"),$_smarty_tpl);?>
</a>
					</div>
				</div>
				<?php }?> <?php }?>
		...
		<div style="width: 33%; float: left;">
			<div class="short-description" itemprop="description">
				<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Montage",'d'=>"hookkonfigurator.fo.default"),$_smarty_tpl);?>
:</p>
				<p><?php echo $_smarty_tpl->tpl_vars['MONTAGETEXT']->value;?>
</p>
			</div>
		</div>
	</article> <!-- /product -->

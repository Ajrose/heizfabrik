		...
		<div class="row">
			...
			<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
				<ul class="nav nav-pills pjAsNav">
					<li<?php echo $_GET['layout'] == 2 ? ' class="active"' : NULL;?>><a href="#" class="btn btn-default pjAsBtn pjAsSwitchLayout" data-layout="2"><?php __('front_browse_services');?></a></li>
					<li<?php echo $_GET['layout'] == 1 ? ' class="active"' : NULL;?>><a href="#" class="btn btn-default pjAsBtn pjAsSwitchLayout"  data-layout="1"><?php __('front_browse_professionalists');?></a></li>
		...
		<li class="list-group-item">
			<div class="row">
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pjAsSelectedDate">
					<?php __('front_selected_date');?>: <strong><?php echo date($tpl['option_arr']['o_date_format'], strtotime($_GET['date']));?></strong>
				</div>
				<?php
				if(!isset($show_both))
				{ 

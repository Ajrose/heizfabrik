							...
							<li class="list-group-item pjAsListElement pjAsService">
								<div class="row">
									...
									<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
										...
										{
											?><a href="#" class="btn btn-default pjAsBtn pjAsBtnPrimary pjAsServiceAppointment" data-iso="<?php echo $_GET['date']; ?>" data-id="<?php echo $service['id'];?>" data-slug="<?php echo $slug;?>"><?php __('front_make_appointment');?></a><?php
										} 
										?>
